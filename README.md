...
You can download flash dealer and sdk here(realease)

## Wiki

You can see detail of the descripe of the interface here

You can learn more abount QBMonetary here
...
# QBMonetary Maker Strategy

```shell
python3 QBMonetary.py
```
